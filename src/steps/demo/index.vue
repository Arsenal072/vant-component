<template>
  <demo-section>
    ...
    <van-button size="middle" @click="nextStep">
      {{ $t('nextStep') }}
    </van-button>

    <demo-block :title="$t('customStyle')">
      <van-steps :active="active" active-icon="checked" inactive-icon="arrow">
        <van-step>{{ $t('step1') }}</van-step>
        <van-step>{{ $t('step2') }}</van-step>
        <van-step>{{ $t('step3') }}</van-step>
        <van-step>{{ $t('step4') }}</van-step>
    ...
    <demo-block :title="$t('title3')">
      <van-steps :active="0" direction="vertical">
        <van-step>
          <p>{{ $t('status1') }}</p>
          <p class="margin-top6 font-size-2">2016-07-12 12:40</p>
        </van-step>
        <van-step>
          <p>{{ $t('status2') }}</p>
          <p class="margin-top6 font-size-2">2016-07-11 10:00</p>
        </van-step>
        <van-step>
          <p>{{ $t('status1') }}</p>
          <p class="margin-top6 font-size-2">2016-07-12 12:40</p>
        ...
        <van-step>
          <p>{{ $t('status3') }}</p>
          <p class="margin-top6 font-size-2">2016-07-10 09:30</p>
        </van-step>
      </van-steps>
    </demo-block>
  </demo-section>
