  ...
  <demo-section>
    <demo-block :title="$t('basicUsage')">
      <van-swipe :autoplay="3000" :height="160">
        ...
        <van-swipe-item
          default="http://mui.ucmed.cn/images/default/avatar1.png"
        >
          3
        </van-swipe-item>
        <van-swipe-item
    ...
    <demo-block :title="$t('singleMode')">
      <van-swipe type="single" :height="160">
        <van-swipe-item default="1">1</van-swipe-item>
      </van-swipe>
    </demo-block>

    <demo-block :title="$t('maskMode')">
    ...
    <demo-block :title="$t('title3')">
      <van-swipe :height="160" @change="onChange1">
        <van-swipe-item default="1">1</van-swipe-item>
        <van-swipe-item default="1">2</van-swipe-item>
        <van-swipe-item default="1">3</van-swipe-item>
        <van-swipe-item default="1">4</van-swipe-item>
      </van-swipe>
    </demo-block>
